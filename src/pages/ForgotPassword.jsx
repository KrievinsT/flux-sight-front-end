          ...
          {!isSubmitted ? (
            ...
            <div className="w-full max-w-md bg-white rounded-lg shadow-lg p-6 relative">
              ...
              {confirmPasswordError && (
                  <div className="text-red-500 font-medium mt-2">{confirmPasswordError}</div>
                )}
            ...
            <div className="w-full max-w-md bg-white rounded-lg shadow-lg p-6 relative">
              ...
              <div className="bg-gray-900 text-white w-full text-center rounded-lg py-4 -mt-12 px-6" style={{ backgroundImage: 'linear-gradient(195deg, #42424a, #191919)' }} >
                ...
                <div className="flex justify-center mt-6 mb-3 space-x-4">
                  We have sent the password reset code to {email}.
                </div>
              </div>
              <form onSubmit={handleCodeSubmit} className="px-0 pt-6 pb-6">
                <div className="mb-4 mt-4 flex justify-center space-x-4">
                  {/* 5 boxes to enter code */}
                ...
                {codeError && <div className="text-red-500 font-medium mt-2">{codeError}</div>}
              </form>
              <div className="text-center text-sm font-medium text-gray-600 flex justify-center">
                Didn't recieve the email?
                <div
                  className="text-sm text-blue-500 hover:text-blue-700 ml-2 cursor-pointer"
                  onClick={toggleForm}
                >
                  Click here!
                </div>
